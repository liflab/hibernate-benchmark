...
/**
 * Source whose events are arrays of size 3. The contents of the array are:
 * <ol>
 * <li>A numerical "slice" label</li>
 * <li>An event counter</li>
 * <li>A string label, which is either "Start", "End" or "Foo"</li>
 * </ol>
 */
public class RandomLabelSource extends RandomSource
{
  ...
  /**
   * The name of the parameter "slice length"
   */
  public static final String SLICE_LENGTH = "Slice length";
  
  /**
   * The name of the parameter "number of slices"
   */
  public static final String NUM_SLICES = "Number of slices";
  ...
  protected Object getEvent()
  {
    ...
    if (state_size < m_numSlices)
    {
      ...
      tuple.add(m_highestSliceId);
      tuple.add(m_eventCount);
      tuple.add(LABEL_START);
      m_highestSliceId++;
    }
    else
    {
      ...
      if (num_e < m_sliceLength - 1)
      {
        ...
        tuple.add(m_sliceIndex);
        tuple.add(m_eventCount);
        tuple.add(LABEL_OTHER);
